...
const getAccountIcon = (name: string, index: number) => {
  ...
  if (lower.includes("cash") || lower.includes("wallet")) {
    return <Banknote className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-500" />;
  }
  if (
    lower.includes("card") ||
  ...
  if (
    ...
    return <Building2 className="h-4 w-4 sm:h-5 sm:w-5 text-violet-500" />;
  }
  const icons = [
    <Building2 key="1" className="h-4 w-4 sm:h-5 sm:w-5 text-violet-500" />,
    <Wallet key="2" className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-500" />,
    <CreditCard key="3" className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500" />,
    <Banknote key="4" className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-500" />,
    <Coins key="5" className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500" />,
  ];
    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
        ...
        <Button
          ...
          size="sm"
          className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-xs gap-1.5 w-full sm:w-auto"
        >
            ...
            >
              <CardContent className="p-3.5 sm:p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] uppercase font-bold text-muted-foreground/60 px-1.5 py-0.5 rounded bg-muted shrink-0">
                    Acc #{index + 1}
                  </span>
                </div>
                <p className="text-lg sm:text-xl font-bold mt-2.5 text-foreground">
